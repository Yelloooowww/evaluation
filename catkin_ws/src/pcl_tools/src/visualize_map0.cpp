...
Visualize_map::Visualize_map(NodeHandle &nh)
{
    ...
    pub_map = nh.advertise<sensor_msgs::PointCloud2>("/robot/map_part", 1);
    Reader.read("/home/argsubt/pokingbot-rl/autonomous_exploration_development_environment/part_map.ply", *cloud);
